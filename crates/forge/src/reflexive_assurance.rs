...
mod kani_proofs {
    ...
    fn embedding_trust_gate_is_conjunctive() {
        ...
        kani::assert(
            ...
            "embedding trust gate must be exact conjunction",
        );
    }
        ...
        kani::assert(
            fired
                == (has_prompt
                    ...
                    && tool_after_extraction
                    && !has_gate),
            "prompt/tool interference gate must require order and missing declassification",
        );
    }
        ...
        kani::assert(
            fired
                == (has_map
                    ...
                    && revoke_after_activity
                    && !unmap_after_revoke),
            "DMA revocation gate must require missing unmap dominance",
        );
    }
}
